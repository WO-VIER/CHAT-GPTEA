...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\chatgpt-like\\public\\storage',
...
'mail.markdown.paths','openai.api_key','openai.organization','openai.project','openai.base_uri',
'openai.request_timeout','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.openrouter.base_url','services.openrouter.api_key',
...
'other-browser-sessions.destroy','current-user-photo.destroy','current-user.destroy','sanctum.csrf-cookie','dashboard','ask.index','ask.post',
'ask.list','provider-icons.index',
'provider-icons.list','provider-icons.populate','ai-models.index','ai-models.list','ai-models.populate',
'ai-models.nullproviderIcons','ai-models.populateNotAuth','storage.local',);
...
'OPENROUTER_API_KEY','OPENAI_ORGANIZATION','DEBUGBAR_ENABLED','APP_NAME','APP_ENV',
'APP_KEY','APP_DEBUG','LOG_LEVEL','APP_URL','APP_LOCALE',
