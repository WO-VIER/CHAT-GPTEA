...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\chatgpt-like\public\storage' => 'string',
            ...
            'laravel-to-uml.route' => 'string',
            'laravel-to-uml.casts' => 'boolean',
            'laravel-to-uml.channels' => 'boolean',
            'laravel-to-uml.commands' => 'boolean',
            'laravel-to-uml.components' => 'boolean',
            'laravel-to-uml.controllers' => 'boolean',
            'laravel-to-uml.events' => 'boolean',
            'laravel-to-uml.exceptions' => 'boolean',
            'laravel-to-uml.jobs' => 'boolean',
            'laravel-to-uml.listeners' => 'boolean',
            'laravel-to-uml.mails' => 'boolean',
            'laravel-to-uml.middlewares' => 'boolean',
            'laravel-to-uml.models' => 'boolean',
            'laravel-to-uml.notifications' => 'boolean',
            'laravel-to-uml.observers' => 'boolean',
            'laravel-to-uml.policies' => 'boolean',
            'laravel-to-uml.providers' => 'boolean',
            'laravel-to-uml.requests' => 'boolean',
            'laravel-to-uml.resources' => 'boolean',
            'laravel-to-uml.rules' => 'boolean',
            'laravel-to-uml.style.background' => 'string',
            'laravel-to-uml.style.stroke' => 'string',
            'laravel-to-uml.style.arrowSize' => 'integer',
            'laravel-to-uml.style.bendSize' => 'double',
            'laravel-to-uml.style.direction' => 'string',
            'laravel-to-uml.style.gutter' => 'integer',
            'laravel-to-uml.style.edgeMargin' => 'integer',
            'laravel-to-uml.style.gravity' => 'integer',
            'laravel-to-uml.style.edges' => 'string',
            'laravel-to-uml.style.fill' => 'string',
            'laravel-to-uml.style.fillArrows' => 'boolean',
            'laravel-to-uml.style.font' => 'string',
            'laravel-to-uml.style.fontSize' => 'integer',
            'laravel-to-uml.style.leading' => 'double',
            'laravel-to-uml.style.lineWidth' => 'integer',
            'laravel-to-uml.style.padding' => 'integer',
            'laravel-to-uml.style.spacing' => 'integer',
            'laravel-to-uml.style.title' => 'string',
            'laravel-to-uml.style.zoom' => 'integer',
            'laravel-to-uml.style.acyclicer' => 'string',
            'laravel-to-uml.style.ranker' => 'string',
            'laravel-to-uml.excludeFiles' => 'array',
            'laravel-to-uml.directories.casts' => 'string',
            'laravel-to-uml.directories.channels' => 'string',
            'laravel-to-uml.directories.commands' => 'string',
            'laravel-to-uml.directories.components' => 'string',
            'laravel-to-uml.directories.controllers' => 'string',
            'laravel-to-uml.directories.events' => 'string',
            'laravel-to-uml.directories.exceptions' => 'string',
            'laravel-to-uml.directories.jobs' => 'string',
            'laravel-to-uml.directories.listeners' => 'string',
            'laravel-to-uml.directories.mails' => 'string',
            'laravel-to-uml.directories.middlewares' => 'string',
            'laravel-to-uml.directories.models' => 'string',
            'laravel-to-uml.directories.notifications' => 'string',
            'laravel-to-uml.directories.observers' => 'string',
            'laravel-to-uml.directories.policies' => 'string',
            'laravel-to-uml.directories.providers' => 'string',
            'laravel-to-uml.directories.requests' => 'string',
            'laravel-to-uml.directories.resources' => 'string',
            'laravel-to-uml.directories.rules' => 'string',
            ...
            'services.openrouter.base_url' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\chatgpt-like\\public\\storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'jetstream.features','jetstream.profile_photo_disk','jetstream.auth_session','jetstream.guard','laravel-to-uml.route',
'laravel-to-uml.casts','laravel-to-uml.channels','laravel-to-uml.commands','laravel-to-uml.components','laravel-to-uml.controllers',
'laravel-to-uml.events','laravel-to-uml.exceptions','laravel-to-uml.jobs','laravel-to-uml.listeners','laravel-to-uml.mails',
'laravel-to-uml.middlewares','laravel-to-uml.models','laravel-to-uml.notifications','laravel-to-uml.observers','laravel-to-uml.policies',
'laravel-to-uml.providers','laravel-to-uml.requests','laravel-to-uml.resources','laravel-to-uml.rules','laravel-to-uml.style.background',
'laravel-to-uml.style.stroke','laravel-to-uml.style.arrowSize','laravel-to-uml.style.bendSize','laravel-to-uml.style.direction','laravel-to-uml.style.gutter',
'laravel-to-uml.style.edgeMargin','laravel-to-uml.style.gravity','laravel-to-uml.style.edges','laravel-to-uml.style.fill','laravel-to-uml.style.fillArrows',
'laravel-to-uml.style.font','laravel-to-uml.style.fontSize','laravel-to-uml.style.leading','laravel-to-uml.style.lineWidth','laravel-to-uml.style.padding',
'laravel-to-uml.style.spacing','laravel-to-uml.style.title','laravel-to-uml.style.zoom','laravel-to-uml.style.acyclicer','laravel-to-uml.style.ranker',
'laravel-to-uml.excludeFiles','laravel-to-uml.directories.casts','laravel-to-uml.directories.channels','laravel-to-uml.directories.commands','laravel-to-uml.directories.components',
'laravel-to-uml.directories.controllers','laravel-to-uml.directories.events','laravel-to-uml.directories.exceptions','laravel-to-uml.directories.jobs','laravel-to-uml.directories.listeners',
'laravel-to-uml.directories.mails','laravel-to-uml.directories.middlewares','laravel-to-uml.directories.models','laravel-to-uml.directories.notifications','laravel-to-uml.directories.observers',
'laravel-to-uml.directories.policies','laravel-to-uml.directories.providers','laravel-to-uml.directories.requests','laravel-to-uml.directories.resources','laravel-to-uml.directories.rules',
...
'openai.organization','openai.project','openai.base_uri','openai.request_timeout','queue.default',
...
'services.slack.notifications.channel','services.openrouter.base_url','services.openrouter.api_key','session.driver','session.lifetime',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js',
...
'profile.show','other-browser-sessions.destroy','current-user-photo.destroy','current-user.destroy','sanctum.csrf-cookie',
...
'log-viewer.files.delete-multiple-files','log-viewer.logs','log-viewer.folders.download','log-viewer.files.download','log-viewer.index','ask.index','ask.post',
'ask.newConversation','ask.select-conversation','ask.debug','stream.message','instructions.index',
'instructions.post','instructions.list','message.index','message.store','ask.list',
'aimodel.populate','user.show','provider-icons.index','provider-icons.list',
'provider-icons.populate','ai-models.index','ai-models.list','ai-models.populate','ai-models.nullproviderIcons',
'ai-models.populateNotAuth','storage.local',);
...
'laravel-exceptions::layout','laravel-exceptions::minimal','laravel-to-uml::uml','log-viewer::index','notifications::email',
...
'OPENROUTER_API_KEY','OPENAI_ORGANIZATION','DEBUGBAR_ENABLED','DEBUGBAR_INJECT_AJAX','APP_NAME',
'APP_ENV','APP_KEY','APP_DEBUG','LOG_LEVEL','APP_URL',
